# Continental Construction website

- Audience: Auckland homeowners considering a new build, renovation, recladding, deck or fence.
- Primary action: call or text 0210622832. No email supplied.
- Confirmed priority: Why choose us is the second screen, immediately after the hero/service strip. Address NZ developer concerns: scope/cost/cash flow, programme, variations, verifiable quality, accountability and handover. Never fabricate an 80% survey claim.
- Register: brand. Soul: architectural editorial, confident and approachable.
- Dials: SOUL 8, SPECTACLE 4, DENSITY 4. Engine: CSS photographic settling/reveal and one review marquee.
